...
public class RubricaController {
	...
	public boolean newRubrica(@RequestBody RubricaDTO dto) {
		System.out.println("enter in new");
		return service.newRubrica(dto);
	}
	...
	public boolean newContatto(@PathVariable int id, @RequestBody ContattoDTO c) {
		System.out.println("enter in new contatto");
		return cservice.newContatto(id, c);
	}
